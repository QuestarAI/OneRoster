        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SchoolYearId = table.Column<string>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResourceId1 = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ResourceRole", x => new { x.ResourceId, x.Role });
                    table.ForeignKey(
                        name: "FK_ResourceRole_Resource_ResourceId1",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GradingPeriodId = table.Column<string>(nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ResourceRole_ResourceId1",
                table: "ResourceRole",
                column: "ResourceId1");
