...
namespace Questar.OneRoster.Data.Migrations
{
    ...
    [Migration("20181128165032_Create")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Questar.OneRoster.Data.LineItem", b =>
                {
                    ...
                    b.Property<double?>("ResultValueMax")
                        .IsRequired();

                    b.Property<double?>("ResultValueMin")
                        .IsRequired();
            ...
            modelBuilder.Entity("Questar.OneRoster.Data.Organization", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Questar.OneRoster.Data.Result", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("ScoreDate")
                        .IsRequired();
            ...
            modelBuilder.Entity("Questar.OneRoster.Data.UserOrganization", b =>
                {
                    b.Property<Guid>("UserId");
            ...
            modelBuilder.Entity("Questar.OneRoster.Data.Class", b =>
                {
                    ...
                    b.HasOne("Questar.OneRoster.Data.Organization", "School")
                        .WithMany("Classes")
            ...
            modelBuilder.Entity("Questar.OneRoster.Data.Course", b =>
                {
                    ...
                    b.HasOne("Questar.OneRoster.Data.Organization", "Organization")
                        .WithMany("Courses")
            ...
            modelBuilder.Entity("Questar.OneRoster.Data.Organization", b =>
                {
                    ...
                    b.HasOne("Questar.OneRoster.Data.Organization", "Parent")
                        .WithMany("Children")
                        .HasForeignKey("ParentId");
                });
