    ...
    public partial class Create : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table => { table.PrimaryKey("PK_MetadataCollection", x => x.Id); });
            ...
            migrationBuilder.CreateTable(
                ...
                table => new
                {
                    ...
                    MetadataCollectionId = table.Column<int>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    UserId = table.Column<int>(),
                    Type = table.Column<string>(maxLength: 256),
                    Identifier = table.Column<string>(maxLength: 256)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                table => new
                {
                    ...
                    AcademicSessionId = table.Column<int>()
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                table => new
                {
                    ...
                    GradingPeriodId = table.Column<int>(),
