        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssignDate = table.Column<DateTimeOffset>(nullable: false),
                    DueDate = table.Column<DateTimeOffset>(nullable: false),
                    ClassId = table.Column<Guid>(nullable: false),
                    CategoryId = table.Column<Guid>(nullable: false),
                    GradingPeriodId = table.Column<Guid>(nullable: false),
                    ResultValueMin = table.Column<double>(nullable: false),
                    ResultValueMax = table.Column<double>(nullable: false),
                    Id = table.Column<Guid>(nullable: false),
                    MetadataCollectionId = table.Column<Guid>(nullable: true),
                    Active = table.Column<bool>(nullable: false),
                    Modified = table.Column<DateTimeOffset>(nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScoreDate = table.Column<DateTimeOffset>(nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Organization_Identifier",
                table: "Organization",
                column: "Identifier");
