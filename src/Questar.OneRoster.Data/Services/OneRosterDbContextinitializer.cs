namespace Questar.OneRoster.Data.Services
{
    ...
    public class OneRosterDbContextInitializer
    {
        ...
        public void Initialize()
        {
            ...
            var nation = new Org(OrgType.National)
            {
                Name = "My Nation"
            };
            var state = new Org(OrgType.State)
            {
                Name = "My State",
                Parent = nation
            };
            var local = new Org(OrgType.Local)
            {
                Name = "My Local",
                Parent = state
            };
            ...
            var resource = new Resource
            {
                ...
                VendorResourceId = "my-vendor-id-98a47dd5-4829-4556-a57b-bb89fff89506",
                Roles =
                {
                    new ResourceRole(UserType.Administrator),
                    new ResourceRole(UserType.Teacher),
                    new ResourceRole(UserType.Student)
                }
            };
            ...
            var course = new Course
            {
                ...
                Grades =
                {
                    new CourseGrade(grade)
                },
                Resources =
                {
                    new CourseResource(resource)
                },
                Subjects =
                {
                    new CourseSubject(subject)
                }
            };
            ...
            var administrator = new User(UserType.Administrator)
            {
                ...
                Ids =
                {
                    new UserIdentifier("Foo", "7dd5300e-30a1-4f0e-a849-23a9ddc9ff3b")
                },
                Orgs =
                {
                    new UserOrg(district)
                }
            };
            var student = new User(UserType.Student)
            {
                ...
                Results =
                {
                    new Result(item)
                    {
                        ...
                        ScoreStatus = ResultScoreStatus.FullyGraded
                    }
                },
                Orgs =
                {
