    ...
    internal class Entity
    {
        ...
        internal static List<Entity> BuildEntities()
        {
            return new List<Entity>
            {
                ...
                {
                    BarInt = 1,
                    BazDateTime = Util.UtcDate(2017, 5, 21),
                ...
                {
                    BarInt = 2,
                    BazDateTime = Util.UtcDate(2018, 5, 21),
                ...
                {
                    BarInt = 3,
                    BazDateTime = Util.UtcDate(2019, 5, 21),
                ...
                {
                    BarInt = 4,
                    BazDateTime = Util.UtcDate(2018, 4, 21),
                ...
                {
                    BarInt = 6,
                    BazDateTime = Util.UtcDate(2018, 6, 21),
                ...
                {
                    BarInt = 6,
                    BazDateTime = Util.UtcDate(2018, 5, 20),
                ...
                {
                    BarInt = 8,
                    BazDateTime = Util.UtcDate(2018, 5, 22),
