namespace Questar.OneRoster.Dto
{
    ...
    public class DemographicsDto<TGender, TCountryCode, TStateCode, TPublicSchoolResidenceStatus> : Base
    {
    ...
    public class DemographicsDto : DemographicsDto<Gender, CountryCode, StateCode, PublicSchoolResidenceStatus> { }
}