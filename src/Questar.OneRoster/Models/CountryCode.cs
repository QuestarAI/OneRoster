...
namespace Questar.OneRoster.Models
{
    ...
    public enum CountryCode
    {
        ...
        [EnumMember(Value = "CD")] CongoDemocraticRepublicOfThe,
        ...
        [EnumMember(Value = "GB")] UnitedKingdomOfGreatBritainAndNorthernIreland,

        [EnumMember(Value = "US")] UnitedStatesOfAmerica,
