...
namespace Questar.OneRoster.Payloads
{
    ...
    {
        [JsonProperty("imsx_codeMajor")] public CodeMajor CodeMajor { get; set; }

        [JsonProperty("imsx_codeMinor")] public CodeMinor CodeMinor { get; set; }

        [JsonProperty("imsx_severity")] public Severity Severity { get; set; }

        [JsonProperty("imsx_description")] public string Description { get; set; }
