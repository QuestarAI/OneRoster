namespace Questar.OneRoster.ApiFramework.Extensions
{
    ...
    public static class QueryableExtensions
    {
        ...
        public static Task<IEnumerable<object>> ToListAsync<T>(this IQueryable<T> dbSet, CollectionEndpointContext<T> context) where T : class
            => dbSet
        ...
        public static async Task<int> CountAsync<T>(this IQueryable<T> dbSet, CollectionEndpointContext<T> context) where T : class
            => dbSet
            .HandleFilter(context)
